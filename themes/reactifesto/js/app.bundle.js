...
/***/ function(module, exports, __webpack_require__) {
	...
	var URL = "http://reactifesto.dev/wp-json/wp/v2/posts?_embed";
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'posts' },
	        _react2.default.createElement(_home2.default, { posts: this.state.posts })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _postItem = __webpack_require__(161);
	...
	var PostList = function PostList(props) {
	  var posts = props.posts.map(function (post) {
	    return _react2.default.createElement(_postItem2.default, { key: post.id, post: post });
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PostItem = function PostItem(props) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement("div", { className: "post__single-text", dangerouslySetInnerHTML: { __html: postContent } })
	  );
	};
